...
class ContextsControllerTest < ActionController::TestCase
  ...
  test "should create context" do
    assert_difference('Context.count') do
      post :create, context: { desription: @context.desription, slug: @context.slug, title: @context.title, type: @context.type, user_id: @context.user_id }
    end
  ...
  test "should update context" do
    patch :update, id: @context, context: { desription: @context.desription, slug: @context.slug, title: @context.title, type: @context.type, user_id: @context.user_id }
    assert_redirected_to context_path(assigns(:context))
  end
